...
All of it lives in the app's private storage on your device:

- **Your food catalog** — names, carbohydrate values per 100 g/ml, portion sizes, units,
  and the icon or photo you chose for each item.
- **Your meal history** — what you logged, how much, when, and the calculated carb totals.
- **Photos you attach**, downscaled to roughly 400 px.
- **Your settings.**

No name, email address, phone number, contacts, location or device identifier is
...
- The data goes to your personal Google Drive backup quota, not to the developer.
- On modern Android versions this backup is end-to-end encrypted with your device
  PIN, pattern or password, meaning Google cannot read its contents.
- It is governed by [Google's Privacy Policy](https://policies.google.com/privacy).
- You can switch it off entirely: **Settings → Google → Backup**.

One-off photos taken for AI analysis are deliberately excluded from cloud backup.
...
Deleting an item or a meal removes it, and its photo, immediately and permanently.
Uninstalling the app erases everything it holds. If Auto Backup is enabled, remove the
retained copy at [drive.google.com](https://drive.google.com) → Storage → Backups, or by
turning backup off before uninstalling.
...
Any material change to this policy will be published with a new "last updated" date and
accompany an app update.
